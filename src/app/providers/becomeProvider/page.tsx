      ...
      <div className="container px-4 sm:px-0">
          ...
          <div className="start_infos">
            <div className="section-title">
              ...
              <div className="sub-title">
                commencez votre inscription et voyez combien vous pouriez gagner
                en tant que tasker
              </div>
            </div>
            <div className="register">
              <form action="" className="flex flex-col gap-8 sm:px-5">
                ...
                <button className="btn-primary w-full text-[18px]">
        ...
        <div className="section">
          <div className="section-title">
            ...
            <div className="sub-title">
              Suivez ces étapes simples pour commencer à gagner de l'argent en
              tant que tasker
            </div>
          </div>
      ...
      >
        <div className="section-what-easereserve_content container px-4 sm:px-0">
          ...
          <div className="desscription font-Quicksand text-center text-[15px] md:text-[18px] font-[400] max-w-[700px] m-[0_auto] flex flex-col gap-4">
            TaskRabbit connects busy people in need of help with trusted local
            Taskers who can lend a hand with everything from home repairs to
            errands. As a Tasker, you can get paid to do what you love, when and
            where you want — all while saving the day for someone in your city.
